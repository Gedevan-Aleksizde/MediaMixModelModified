...
ORIGINAL SOURCE CODE by  Jin, Y., Wang, Y., Sun, Y., Chan, D. & Koehler, J. (2017)
https://research.google/pubs/pub46001/

NOTE: some dated Stan syntaces are updated and an unused variable is deleted.
...
data {
  ...
  // row_vector[max_lag] lag_vec;  // unused
